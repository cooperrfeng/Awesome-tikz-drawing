\documentclass[border=28pt, multi, tikz]{standalone} 
\usepackage{import}
...
\draw [connection]  (pool2-east)    -- node {\midarrow} node[above=3pt  ]{$  FC$}  (conv3-west);
...
\draw [connection]  (conv3-east)    -- node {\midarrow} node[above=3pt]{$FC$} (conv4-west);
